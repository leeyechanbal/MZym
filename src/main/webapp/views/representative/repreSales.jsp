                                ...
                                <div class="modal-body">
                                    <form id="insert_form" action="<%=contextPath %>/insertSale.re" method="get">
                                        <table class="change_sale">
                                            ...
                                            <tr>
                                                <th>구매날짜</th>
                                                <td><input type="date" class="form-control date" placeholder="xxxx-xx-xx(-포함하여 입력해주세요)" id="input_date" name="insert_date"></td>
                                            </tr>
                                        </table>
                                        <div class="table_btn">
                                ...
                                <div class="modal-body">
                                    <form id="change_form" action="<%=contextPath %>/deletePayment.re" method="post" >
                                        <table class="change_sale">
                                            ...
                                            <tr>
                                                <th>구매날짜</th>
                                                <td><input type="date" class="form-control date" placeholder="xxxx-xx-xx(-포함하여 입력해주세요)" required id="update_date"></td>
                                            </tr>
                                        </table>
                                        <div class="table_btn">
